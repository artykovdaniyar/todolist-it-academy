...
},{"./TaskList":4}],3:[function(require,module,exports){
"use strict";
...
},{"./Modal":2,"./TaskList":4}],4:[function(require,module,exports){
"use strict";
...
},{"./TaskItem":3,"./localStorage":5}],5:[function(require,module,exports){
"use strict";
...
var _TaskList = require("./modules/TaskList.js");

var _TaskList2 = _interopRequireDefault(_TaskList);

var _TaskItem = require("./modules/TaskItem.js");
...
var modalCancelButtons = document.querySelectorAll(".modal__btn--cancel");
var modalWindows = document.querySelectorAll(".modal");
var taskDeleteButton = document.querySelectorAll(".todo-item__delete");
var createTaskSaveButton = document.querySelector(".modal__btn--save");
var deleteTaskButton = document.querySelector(".modal__btn--delete");
var changeTaskButton = document.querySelector(".modal__btn--change");

createTaskSaveButton.addEventListener("click", function (event) {
	event.preventDefault();
	var isValid = modal.inputValidation(event);
	if (isValid) {
		task.createTask(event, _TaskList2.default);
		_TaskList2.default.render();
		modal.hideModal(modalWindows);
	}
});
...
modalCancelButtons.forEach(function (btn) {
	btn.addEventListener("click", function () {
		modal.hideModal(modalWindows);
	});
});
...
},{"./modules/LocalStorage":1,"./modules/Modal":2,"./modules/TaskItem.js":3,"./modules/TaskList.js":4}]},{},[6]);
